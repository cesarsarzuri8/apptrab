...
class InfoParaDestacarPublicacionPage2 extends StatefulWidget {
  final Map urlsImagesParaDestacarPublicacion;
  InfoParaDestacarPublicacionPage2({Key key,this.urlsImagesParaDestacarPublicacion}) : super(key: key);


  @override
  _InfoParaDestacarPublicacionPage2State createState() => _InfoParaDestacarPublicacionPage2State();
}

class _InfoParaDestacarPublicacionPage2State extends State<InfoParaDestacarPublicacionPage2> {
...
//  urlImagePublicacion
//  urlImageComprobantePago
  @override
  void initState() {
    super.initState();
    if(widget.urlsImagesParaDestacarPublicacion.length>0){
      _imageFilePublicacion=widget.urlsImagesParaDestacarPublicacion["urlImagePublicacion"];
      _imageFileDeposito=widget.urlsImagesParaDestacarPublicacion["urlImageComprobantePago"];
    }
...
//    widget.imagesParaDestacarPublicacion=[_imageFilePublicacion,_imageFileDeposito];
//    Navigator.pop(context, widget.imagesParaDestacarPublicacion);
