...
class InfoParaDestacarPublicacionPage1 extends StatefulWidget {
  ...
  InfoParaDestacarPublicacionPage1({Key key,this.imagesParaDestacarPublicacion}) : super(key: key);
...
class _InfoParaDestacarPublicacionPage1State extends State<InfoParaDestacarPublicacionPage1> {
  ...
  void initState() {
    super.initState();
    if(widget.imagesParaDestacarPublicacion.length>0){
      _imageFilePublicacion=widget.imagesParaDestacarPublicacion[0];
      _imageFileDeposito=widget.imagesParaDestacarPublicacion[1];
    }
